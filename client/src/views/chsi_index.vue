        ...
        <div class="index">
            ...
            <Row type="flex" justify="center" align="middle" style="position: relative;z-index: 3">
                <i-col span="24">
                    ...
                    <!-- <h2>{{ $t('index.title') }}</h2> -->
                    <div class="list">
                        <router-link :to="'/post/article' + suffix">{{ $t('index.post') }}</router-link>
                        <router-link :to="'/docs/icons/introduce' + suffix">{{ $t('index.icons') }}</router-link>
                        <router-link :to="'/docs/teccol' + suffix">{{ $t('index.technology_category') }}</router-link>
                        <router-link :to="'/docs/favor' + suffix">{{ $t('index.network_resource_library') }}</router-link>
                        <router-link :to="'/member' + suffix">{{ $t('index.team_member') }}</router-link>
                    </div>
                </i-col>
            </Row>
        </div>
